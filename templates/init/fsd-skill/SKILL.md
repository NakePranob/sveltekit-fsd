...
description: >
  ...
  Router, Nuxt, SvelteKit, Vite, Astro), or implementing common patterns such
  as authentication, API handling, Redux, and TanStack Query (React Query)
  within FSD.
---
...
- **When integrating FSD with a specific framework** (Next.js with App Router
  or Pages Router, Nuxt, SvelteKit, Vite, CRA, Astro) for wiring routes to FSD pages,
